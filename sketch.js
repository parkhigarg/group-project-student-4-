...
function draw() { 
  ...
  if(backgr.x<100){
    ...
    if(obstaclesGroup2.isTouching(player)){
      ...
      obsticalGroup2.destroyEach;
      //descrease the scale of the player
      if(player.isTouching(obstical2)) {
...
function spawnObstacles2() {
  ...
  if (frameCount % 240 === 0) {
     var obsticle2 = createSprite()
     obstacle2.addImage(obstacal.png);
     obstical2.scale = 2;
     obstacle2.addVelocityx = 2;
     obstacle2.addLifetime = 0;
